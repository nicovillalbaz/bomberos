...
export const getNovedadesByFecha = async (fecha?: string): Promise<VNovedadesFecha[]> => {
  let query = supabase
...
export const createNovedadIngreso = async (): Promise<NovedadGlobal> => {
  ...
  return createNovedadManual({
    tipo: 'ingreso',
    titulo: 'Ingreso a la compaÃ±Ã­a',
    descripcion: `${profile.data?.nombre} ${profile.data?.apellido} ingresÃ³ a la compaÃ±Ã­a.`,
...
export const createNovedadSalida = async (): Promise<NovedadGlobal> => {
  ...
  return createNovedadManual({
    tipo: 'salida',
    titulo: 'Salida de la compaÃ±Ã­a',
    descripcion: `${profile.data?.nombre} ${profile.data?.apellido} se retirÃ³ de la compaÃ±Ã­a.`,
    modulo_origen: 'guardia'
  });
};
...
export const createNovedadAccion = async (accion: string, observaciones?: string): Promise<NovedadGlobal> => {
  ...
  return createNovedadManual({
    tipo: 'accion',
    titulo: `AcciÃ³n realizada: ${accion}`,
    descripcion: observaciones || `${profile.data?.nombre} ${profile.data?.apellido} realizÃ³: ${accion}`,
    modulo_origen: 'guardia'
  });
};
